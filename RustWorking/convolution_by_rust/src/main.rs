...
fn main() -> anyhow::Result<()> {
    let kernel1 = load_48k_32bit_wav("sounds/心之钢_01.wav")?;
    let kernel2 = load_48k_32bit_wav("sounds/心之钢_02.wav")?;
    let kernel3 = load_48k_32bit_wav("sounds/心之钢_03.wav")?;
    let len = kernel1.len();
    let data = load_48k_32bit_wav("sounds/心之钢_01.wav")?;
